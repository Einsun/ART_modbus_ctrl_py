...
def forward(src, dst, direction):
    global real_dat, out_dat, set_values,set_mult,add_flag_1,add_flag_2,sec_flag
    try:
        while True:
            ...
            # 修改寄存器
                ...
                if state ==1:   # 初始阶段
                    ...
                    # 设置温度
                    if out_dat[0]<600:
                        set_add[0]=random.uniform(0,1.5)
                    elif out_dat[0]<650:
                    ...
                    set_random[1]=6
                    if add_flag_1:
                        set_add[1] = random.uniform(40, 64)
                        if out_dat[1] >= 3950:
                            add_flag_1 = False
                    else:
                        set_add[1] = random.uniform(-8,4)
                    ...
                    set_random[0]=5
                    set_add[1]=-80*(out_dat[1]/max_values[1])
                    set_random[1]=4

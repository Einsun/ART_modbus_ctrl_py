...
state_text = ["0预备", "1低速加速", "2低速匀速", "3高速加速", "4高速匀速", "5泄压降温"]
state = 0
add_flag_1 = True
add_flag_2 = True
add_flag_3 = True
...
def forward(src, dst, direction):
    global real_dat, out_dat, set_values, set_mult, add_flag_1, add_flag_2,add_flag_3,down_flag_1
    try:
        while True:
            ...
            # 修改寄存器
                ...
                if state == 0:
                    ...
                    if down_flag_1:
                        ...
                        set_add[1] = random.uniform(0,120)
                        if out_dat[1]>3000:
                            down_flag_1=True
                ...
                if state == 1:
                    # 设置温度
                    if out_dat[0] < 550:
                        set_add[0] = random.uniform(4, 8) / 2
                        set_random[0] = 5
                    elif out_dat[0] > 1000:
                        set_add[0] = random.uniform(-5, 1)
                    else:
                        set_add[0] = random.uniform(0, ((1800 - out_dat[0]) / 900) ** 2)
                ...
                # 高速阶段
                    ...
                    if out_dat[0] < 1000:
                        ...
                        set_add[0] = random.uniform(0, ((1760-out_dat[0])/500)**2)
                    if out_dat[0] > 1380:
                        set_add[0] = random.uniform(-7, -2)

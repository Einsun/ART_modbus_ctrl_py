...
max_p = 4.01
down_p = 0
txt="选择1,2通道，点击启用劫持，点击预备阶段以开始试验，同时检查网络连接，录屏"
time_0=0
# # ===== HEX / ASCII 打印 =====
        ...
        while True:
            ...
            # 修改寄存器
                ...
                # 2 低速阶段
                    ...
                    # 文字显示
                    if out_dat[0] < 1320:
                        txt="温度到1320度后 电机转速设为 30000，确认设定，点击 3高速"
                    else:
                        txt="电机转速设为 30000，确认设定，点击 3高速"
                ...
                # 3 高速阶段
                    ...
                    if add_flag_2:
                        ...
                        if out_dat[0] < 1000:
                            ...
                            set_add[0] = random.uniform(0, ((1760 - out_dat[0]) / 500) ** 2)*2*rate_t
                        if out_dat[0] > max_t:
                            add_flag_2 = False
                    else:
                        set_add[0] = random.uniform(-6, 1)*rate_t
                        if out_dat[0]<1320:
                            add_flag_2 = True
                    ...
                    if add_flag_1:
                        ...
                        if out_dat[1] >= max_p*1000:
                            out_dat[1] = max_p*1000
                            add_flag_1 = False
                    else:
